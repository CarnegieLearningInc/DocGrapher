...
class ColorizationTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.g1n1 = CLDocFile("g1n1", "/g1n1")
        self.g1n2 = CLDocFile("g1n2", "/g1n2", ["g1n1"])
        self.g1n3 = CLDocFile("g1n3", "/g1n3", ["g1n1"])
        self.g1_nodes = [self.g1n1, self.g1n2, self.g1n3]
        self.g1 = self.create_subgraph(self.g1_nodes)

        # subgraph 2
        # one child, two parents
        self.g2n1 = CLDocFile("g2n1", "/g2n1")
        self.g2n2 = CLDocFile("g2n2", "/g2n2")
        self.g2n3 = CLDocFile("g2n3", "/g2n3", ["g2n1", "g2n2"])
        ...
        self.g3n1 = CLDocFile("g3n1", "/g3n1")
        self.g3n2 = CLDocFile("g3n2", "/g3n2", ["g3n1", "g3n5"])
        self.g3n3 = CLDocFile("g3n3", "/g3n3", ["g3n1"])
        self.g3n4 = CLDocFile("g3n4", "/g3n4", ["g3n2", "g3n3"])
        self.g3n5 = CLDocFile("g3n5", "/g3n5", ["g3n4"])
        self.g3n6 = CLDocFile("g3n6", "/g3n6", ["g3n5"])
